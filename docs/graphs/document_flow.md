...
- If a matching `*.document.yaml` already exists, it is loaded to drive options/page selection and merged formats before rendering. A companion `document_hashes.yaml` controls overwrite/lock behavior.
