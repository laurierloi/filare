...
2025-12-15: Added factories and tests for image and number units plus config (pin/connector/cable/connection/metadata/page options) models. Remaining possible targets: document hash registry helpers and any lingering dataclass-only models where factories would help tests.
