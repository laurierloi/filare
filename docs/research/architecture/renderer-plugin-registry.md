...
- Python imaging/reporting tools (Pillow plugins, Pandas to_* exporters) rely on registries to manage formats and capabilities.
...
- **Pandas**: to_* exporters are discoverable and independently testable.
