...
def test_build_shared_bom_invokes_render(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("filare.flows.shared_bom.generate_shared_bom", fake_generate_shared_bom)
...
def test_build_titlepage_uses_metadata(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("filare.flows.index_pages.generate_titlepage", fake_generate_titlepage)
...
def test_build_pdf_bundle(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr("filare.flows.index_pages.generate_pdf_output", fake_generate_pdf_output)
